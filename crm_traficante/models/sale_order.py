...
class saleOrder(models.Model):
    ...
    def action_confirm(self):
        ...
        for so in self:
            for line in so.order_line:
                ...
                if (line.free_qty_today < line.qty_to_deliver and not line.is_mto and not line.product_id.type == 'service'):
                    pass_flag = False
    ...
    # Dado que se confirma que el agente de ventas sí podrá confirmar pedidos, se regresa a la validación sólo hasta la confirmación. 
    #@api.model
