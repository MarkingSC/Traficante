...
class PurchaseOrderLine(models.Model):
    ...
    receipt_type = fields.Selection(selection = [('regular','Regular'),('credito','Crédito'),('consigna','Consigna')], string='Tipo de recepción', compute=_get_receipt_type, stored=True)
